...
public class ApplicationDbContext : DbContext, IApplicationDbContext
{
    ...
    private void ConfigureWorkspace(EntityTypeBuilder<Workspace> entity)
    {
    ...
    private void ConfigureEmailConfiguration(EntityTypeBuilder<EmailConfiguration> entity) {
        ...
        entity.HasOne(e => e.Workspace)             // An EmailConfiguration has one Workspace
                .WithMany()                        // A Workspace can have many EmailConfigurations (no navigation property on Workspace side)
